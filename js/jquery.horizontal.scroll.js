...
$(".dismiss2").click(function(){
	$("#browserCheck").toggleClass("noDisplay");
});

/*Stuff for the image bar on home page*/
$(".showhide").click(function(){
	$("#container").stop(true, true).fadeToggle("slow", "linear");
	$(".buttonLocation").toggleClass("moveBottom");
});

$(".patternToggle").click(function(){
    $(".overlay").toggleClass("hidePattern");
});

$("#img1").click(function(){
	$("#bg").stop(true, true).fadeOut(200);
	$("#bgimg").delay(200).queue(function(next) { $("#bgimg").attr("src","img/bg/bgfull1.jpg"); next(); });
	$("#bg").delay(200).fadeIn(600);
});
$("#img2").click(function(){
	$("#bg").stop(true, true).fadeOut(200);
	$("#bgimg").delay(200).queue(function(next) { $("#bgimg").attr("src","img/bg/bgfull2.jpg"); next(); });
	$("#bg").delay(200).fadeIn(600);
});
$("#img3").click(function(){
	$("#bg").stop(true, true).fadeOut(200);
	$("#bgimg").delay(200).queue(function(next) { $("#bgimg").attr("src","img/bg/bgfull3.jpg"); next(); });
	$("#bg").delay(200).fadeIn(600);
});
$("#img4").click(function(){
	$("#bg").stop(true, true).fadeOut(200);
	$("#bgimg").delay(200).queue(function(next) { $("#bgimg").attr("src","img/bg/bgfull4.jpg"); next(); });
	$("#bg").delay(200).fadeIn(600);
});
$("#img5").click(function(){
	$("#bg").stop(true, true).fadeOut(200);
	$("#bgimg").delay(200).queue(function(next) { $("#bgimg").attr("src","img/bg/bgfull5.jpg"); next(); });
	$("#bg").delay(200).fadeIn(600);
});
$("#img6").click(function(){
	$("#bg").stop(true, true).fadeOut(200);
	$("#bgimg").delay(200).queue(function(next) { $("#bgimg").attr("src","img/bg/bgfull6.jpg"); next(); });
	$("#bg").delay(200).fadeIn(600);
});
$("#img7").click(function(){
	$("#bg").stop(true, true).fadeOut(200);
	$("#bgimg").delay(200).queue(function(next) { $("#bgimg").attr("src","img/bg/bgfull7.jpg"); next(); });
	$("#bg").delay(200).fadeIn(600);
});
$("#img8").click(function(){
	$("#bg").stop(true, true).fadeOut(200);
	$("#bgimg").delay(200).queue(function(next) { $("#bgimg").attr("src","img/bg/bgfull8.jpg"); next(); });
	$("#bg").delay(200).fadeIn(600);
});
$("#img9").click(function(){
	$("#bg").stop(true, true).fadeOut(200);
	$("#bgimg").delay(200).queue(function(next) { $("#bgimg").attr("src","img/bg/bgfull9.jpg"); next(); });
	$("#bg").delay(200).fadeIn(600);
});
$("#img10").click(function(){
	$("#bg").stop(true, true).fadeOut(200);
	$("#bgimg").delay(200).queue(function(next) { $("#bgimg").attr("src","img/bg/bgfull10.jpg"); next(); });
	$("#bg").delay(200).fadeIn(600);
});
$("#img11").click(function(){
	$("#bg").stop(true, true).fadeOut(200);
	$("#bgimg").delay(200).queue(function(next) { $("#bgimg").attr("src","img/bg/bgfull11.jpg"); next(); });
	$("#bg").delay(200).fadeIn(600);
});
$("#img12").click(function(){
	$("#bg").stop(true, true).fadeOut(200);
	$("#bgimg").delay(200).queue(function(next) { $("#bgimg").attr("src","img/bg/bgfull12.jpg"); next(); });
	$("#bg").delay(200).fadeIn(600);
});
$("#img13").click(function(){
	$("#bg").stop(true, true).fadeOut(200);
	$("#bgimg").delay(200).queue(function(next) { $("#bgimg").attr("src","img/bg/bgfull13.jpg"); next(); });
	$("#bg").delay(200).fadeIn(600);
});
