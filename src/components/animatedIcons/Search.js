...
const SvgSearch = props => {
    ...
    return (
      <div {...props} ref={ref}>
        <SvgIconWrapper name='search' showAnimation={(entry.intersectionRatio) == 1 ? true : false } strokeArray={477}>
          <svg version="1.1" className="svg" id="svg-search" xmlns="http://www.w3.org/2000/svg"
            ...
            <path className="path path--search" fill="transparent" stroke="#000000" strokeWidth="2.5"
