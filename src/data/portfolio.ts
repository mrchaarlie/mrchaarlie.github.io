...
export const portfolioItems: PortfolioItem[] = [
  { slug: 'asana', company: 'Asana', companyLogo: 'asana.svg', title: 'Building a scalable access control framework', thumbnail: 'thumbnail-1.avif', metric1Big: '99%', metric1Description: 'Enterprise adoption', description: 'Designed and implemented a permissions system for Asana\'s work objects, that strengthenend security and governance across the application. Adopted by 99% of top enterprise customers, and unlocked deals' },
  { slug: 'calendly-analytics',  company: 'Calendly', companyLogo: 'calendly.svg', title: 'Launching the industry\'s first scheduling analytics dashboard', thumbnail: 'thumbnail-1.avif', metric1Big: '55%', metric1Description: 'Adoption', metric2Big: '93%', metric2Description: 'CSAT', description: 'Designed a 0–1 analytics feature that gave admins actionable insights into scheduling behavior. Achieved 55% adoption and improved customer retention.' },
  { slug: 'calendly-org-consolidation', company: 'Calendly', companyLogo: 'calendly.svg', title: 'Streamlining enterprise org consolidation', thumbnail: 'thumbnail-1.avif', metric1Big: '3hrs +', metric1Description: 'Time Saved per employee per week', description: 'Built an internal tool that helped internal teams consolidate enterprise accounts, reducing overhead and customer frustration. Eliminated hours of weekly manual work for CSMs while retaining customers.' },
  { slug: 'liveperson-taxonomy-annotation', company: 'LivePerson', companyLogo: 'liveperson.svg', title: 'Accelerating model training with a taxonomy annotation tool', thumbnail: 'thumbnail-1.avif', metric1Big: '86%', metric1Description: 'faster classification',  metric2Big: '26%', metric2Description: 'faster task completion', metric3Big: '–15%', metric3Description: 'Error rate', description: 'Created a high-efficiency annotation tool to accelerate message labeling for model training. Achieved 86% faster classification, 26% faster task completion, and a 15% drop in errors.' },
]
