...
export const portfolioItems: PortfolioItem[] = [
  ...
  { slug: 'calendly-org-consolidation', company: 'Calendly', companyLogo: 'calendly.svg', title: 'Streamlining enterprise org consolidation', thumbnail1: 'thumbnail-calendly-org-1.png', metric1Big: '3hrs +', metric1Description: 'Time Saved per employee per week', description: 'Built an internal tool that helped internal teams consolidate enterprise accounts, reducing overhead and customer frustration. Eliminated hours of weekly manual work for CSMs while retaining customers.' },
